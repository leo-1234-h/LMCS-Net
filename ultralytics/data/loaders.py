...
class LoadStreams:
    ...
    Examples:
        ...
        >>> for sources, images, _ in stream_loader:
        ...     # Process the images
        ...     pass
        >>> stream_loader.close()
    ...
    def __next__(self):
        ...
        for i, x in enumerate(self.imgs):
            ...
            # Get and remove the first frame from images buffer
            if self.buffer:
                images.append(x.pop(0))

            # Get the last frame, and clear the rest from the images buffer
            else:
...
class LoadImagesAndVideos:
    ...
    Examples:
        ...
        >>> for paths, images, info in loader:
