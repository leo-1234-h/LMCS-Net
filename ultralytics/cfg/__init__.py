...
def get_save_dir(args: SimpleNamespace, name: str = None) -> Path:
    ...
    if getattr(args, "save_dir", None):
        ...
        project = args.project or (ROOT.parent / "tests/tmp/run_yolov8_8307" if TESTS_RUNNING else RUNS_DIR) / args.task
...
def handle_yolo_solutions(args: List[str]) -> None:
    """
    Processes YOLO solutions arguments and run_yolov8_8307 the specified computer vision solutions pipeline.
    ...
    Notes:
        ...
        - Output videos are saved in 'run_yolov8_8307/solution/{solution_name}' directory
    ...
    if solution_name == "inference":
        ...
        if solution_name != "crop":
            ...
            if solution_name == "analytics":  # analytical graphs follow fixed shape for output i.e w=1920, h=1080
                w, h = 1280, 720
            save_dir = get_save_dir(SimpleNamespace(project="run_yolov8_8307/solutions", name="exp", exist_ok=False))
            save_dir.mkdir(parents=True)  # create the output directory i.e. run_yolov8_8307/solutions/exp
