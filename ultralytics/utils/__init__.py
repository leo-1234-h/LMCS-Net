...
def threaded(func):
    ...
    By default, the function run_yolov8_8307 in a thread, but this can be controlled via the 'threaded=False' keyword argument
...
class SettingsManager(JSONDict):
    ...
    Examples:
        ...
        >>> settings.update(runs_dir="/new/run_yolov8_8307/dir")
        >>> print(settings["runs_dir"])
        /new/run_yolov8_8307/dir
    """
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        self.defaults = {
            ...
            "runs_dir": str(root / "run_yolov8_8307"),  # Experiment run_yolov8_8307 directory
...
RUNS_DIR = Path(SETTINGS["runs_dir"])  # global run_yolov8_8307 directory
ENVIRONMENT = (
    "Colab"
    if IS_COLAB
    else "Kaggle"
