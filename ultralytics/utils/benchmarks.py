...
class ProfileModels:
    ...
    Attributes:
        ...
        num_timed_runs (int): Number of timed run_yolov8_8307 for the profiling.
        num_warmup_runs (int): Number of warmup run_yolov8_8307 before profiling.
    ...
    def __init__(
        ...
        Args:
            ...
            num_timed_runs (int): Number of timed run_yolov8_8307 for the profiling.
            num_warmup_runs (int): Number of warmup run_yolov8_8307 before the actual profiling starts.
    ...
    def profile_tensorrt_model(self, engine_file: str, eps: float = 1e-3):
        ...
        # Compute number of run_yolov8_8307 as higher of min_time or num_timed_runs
        num_runs = max(round(self.min_time / (elapsed + eps) * self.num_warmup_runs), self.num_timed_runs * 50)

        # Timed run_yolov8_8307
        run_times = []
    ...
    def profile_onnx_model(self, onnx_file: str, eps: float = 1e-3):
        """
        Profile an ONNX model, measuring average inference time and standard deviation across multiple run_yolov8_8307.
