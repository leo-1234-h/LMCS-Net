...
def increment_path(path, exist_ok=False, sep="", mkdir=False):
    """
    Increment a file or directory path, i.e., run_yolov8_8307/exp --> run_yolov8_8307/exp{sep}2, run_yolov8_8307/exp{sep}3, ... etc.
    ...
    Examples:
        ...
        >>> from pathlib import Path
        >>> path = Path("run_yolov8_8307/exp")
        >>> new_path = increment_path(path)
        >>> print(new_path)
        run_yolov8_8307/exp2

        Increment a file path:
        >>> path = Path("run_yolov8_8307/exp/results.txt")
        >>> new_path = increment_path(path)
        >>> print(new_path)
        run_yolov8_8307/exp/results2.txt
    """
