...
def strip_optimizer(f: Union[str, Path] = "yolov8_best.pt", s: str = "", updates: dict = None) -> dict:
    """
    Strip optimizer from 'f' to finalize training, optionally save as 's'.

    Args:
        f (str | Path): File path to model to strip the optimizer from. Defaults to 'yolov8_best.pt'.
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            ...
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as yolov8_best.pt.\n"
