...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.last, self.best = self.wdir / "last.pt", self.wdir / "yolov8_best.pt"  # checkpoint paths
    ...
    def _do_train(self, world_size=1):
        ...
        while True:
            # 1. 更新 BaseTrainer 自己的 epoch 值
            self.epoch = epoch
            # 2. 同步给模型，让 ARConv.forward() 能拿到最新的 epoch
        ...
        if RANK in {-1, 0}:
            # Do final val with yolov8_best.pt
    ...
    def save_model(self):
        ...
        if self.best_fitness == self.fitness:
            self.best.write_bytes(serialized_ckpt)  # save yolov8_best.pt
        ...
        for f in self.last, self.best:
            if f.exists():
                if f is self.last:
                    ...
                    k = "train_results"  # update yolov8_best.pt train_metrics from last.pt
