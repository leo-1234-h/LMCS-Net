...
class Model(torch.nn.Module):
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        if Path(weights).suffix == ".pt":
            ...
            weights = checks.check_file(weights)  # run_yolov8_8307 in all cases, not redundant with above call
    ...
    def reset_callbacks(self) -> None:
        ...
        modifications, ensuring consistent behavior across different run_yolov8_8307 or experiments.
