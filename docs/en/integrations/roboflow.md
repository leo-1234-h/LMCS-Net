...
MODEL_PATH = "path/to/your/run_yolov8_8307/detect/train/"  # Replace with the path to your YOLO11 training results directory
...
# Ensure model_path points to the directory containing 'yolov8_best.pt'
