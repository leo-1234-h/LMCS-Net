...
model = torch.hub.load("ultralytics/yolov5", "custom", path="path/to/yolov8_best.pt")  # local model
model = torch.hub.load("path/to/yolov5", "custom", path="path/to/yolov8_best.pt", source="local")  # local repo
```
